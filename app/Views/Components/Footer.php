    ...
    <div class="container">
            ...
            <div class="footer-brand">
                ...
                <div class="footer-social">
                    <?php if (!empty($social['instagram'])): ?>
                        <a href="<?= htmlspecialchars($social['instagram']) ?>" class="footer-social-link" target="_blank" rel="noopener" aria-label="Instagram">
                    ...
                    <?php if (!empty($social['facebook'])): ?>
                        <a href="<?= htmlspecialchars($social['facebook']) ?>" class="footer-social-link" target="_blank" rel="noopener" aria-label="Facebook">
                    ...
                    <?php if (!empty($social['twitter'])): ?>
                        <a href="<?= htmlspecialchars($social['twitter']) ?>" class="footer-social-link" target="_blank" rel="noopener" aria-label="Twitter / X">
                    ...
                    <?php if (!empty($social['youtube'])): ?>
                        <a href="<?= htmlspecialchars($social['youtube']) ?>" class="footer-social-link" target="_blank" rel="noopener" aria-label="YouTube">
        ...
        <div class="footer-bottom">
            <p class="footer-copyright">
                &copy; <?= $year ?> <?= htmlspecialchars($siteName) ?> · Município do Crato. Todos os direitos reservados.
            </p>
