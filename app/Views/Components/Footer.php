            ...
            <div class="footer-brand">
                ...
                <div class="footer-social">
                    <?php if (!empty($social['instagram'])): ?>
                        <a href="<?= htmlspecialchars($social['instagram']) ?>" class="footer-social-link" target="_blank"
                    ...
                    <?php if (!empty($social['facebook'])): ?>
                        <a href="<?= htmlspecialchars($social['facebook']) ?>" class="footer-social-link" target="_blank"
                    ...
                    <?php if (!empty($social['youtube'])): ?>
                        <a href="<?= htmlspecialchars($social['youtube']) ?>" class="footer-social-link" target="_blank"
