...
$dateStart = $festival['date_start'] ?? '2026-08-25';
$location  = $festival['location']   ?? 'Crato, Alto Alentejo';
$venue     = $festival['venue']      ?? 'Município do Crato';
$edition   = $festival['edition']    ?? '40.ª';

// Ticker items — news & announcements
$tickerItems = [
...
<section class="hero" id="home">
    <div class="hero__bg">
        <img
            src="/themes/crato/img/hero-bg.jpg"
    ...
    <div class="hero__content">
        ...
        <h1 class="hero__title">
            Festival
            <span class="hero__title-accent">Crato</span>
        </h1>

        <!-- Meta -->
        <p class="hero__meta">
            <strong><?= htmlspecialchars($venue) ?></strong> &nbsp;·&nbsp; <?= htmlspecialchars($location) ?>
        </p>
